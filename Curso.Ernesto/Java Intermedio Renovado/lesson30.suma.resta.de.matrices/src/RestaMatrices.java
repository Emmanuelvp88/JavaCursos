public class RestaMatrices {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < matriz1.length; i++) {
            ...
            //if para darle la identacion entre matrices "+"
            if (i == 1) {
                System.out.print(" + ");
            } else {
                System.out.print("   ");
            ...
            //recorre las filas de la 'matriz 2'
            for (int j = 0; j < matriz1[i].length; j++) {
                System.out.print("m2[" + matriz2[i][j] + "]");
            }

            //if para darla idetacion entre matrices "="
            if (i == 1) {
                System.out.print(" =  ");
            } else {
                System.out.print("    ");
            ...
            //recorre las filas de la matriz 'resultados'
            for (int j = 0; j < matriz1[i].length; j++) {
