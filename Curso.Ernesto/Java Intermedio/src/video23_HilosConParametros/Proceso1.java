...
public class Proceso1 extends Thread {
    ...
    /*
     * El metodo "run" es donde se fabrica los hilos y contiene lo que se va
     * ejecutar en lso Hilo s
    ...
    public void run() {
        ...
        // este es un salto de linea es para cada termino del for "Bucle" y se encuentra
        // entro del metodo run.
        System.out.println("");
    }

    /*
     * Este metodo es para mandar a traer un parametro desde otra clase "Main", y es
     * para
